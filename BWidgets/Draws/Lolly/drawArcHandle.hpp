                             ...
                             const BStyles::Color fgColor, const BStyles::Color bgColor)
{
    ...
    (
        cr, 
        xc + 0.8 * radius * cos (BWIDGETS_DEFAULT_DRAWARC_START + rval * BWIDGETS_DEFAULT_DRAWARC_SIZE), 
        yc + 0.8 * radius * sin (BWIDGETS_DEFAULT_DRAWARC_START + rval * BWIDGETS_DEFAULT_DRAWARC_SIZE), 
        0.2 * radius, 
        0.0,
        2.0 * M_PI
    );
