...
#ifndef BWIDGETS_SHAPEWIDGET_HPP_
#define BWIDGETS_SHAPEWIDGET_HPP_

#include "Widget.hpp"
#include "../BUtilities/Shape.hpp"
...
/**
 *  @brief Widget class displaying a Shape in a 2D graph. 
...
class ShapeWidget : public BUtilities::Shape<T, res>
{
public:
	...
	virtual void onFocusIn (BEvents::PointerFocusEvent* event) override;
	virtual void onFocusOut (BEvents::PointerFocusEvent* event) override;
...
#endif /* BWIDGETS_SHAPEWIDGET_HPP_ */
