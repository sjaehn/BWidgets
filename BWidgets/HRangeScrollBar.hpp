...
#define BWIDGETS_DEFAULT_HRANGESCROLLBAR_WIDTH 80
#endif

#ifndef BWIDGETS_DEFAULT_HRANGESCROLLBAR_HEIGHT
#define BWIDGETS_DEFAULT_HRANGESCROLLBAR_HEIGHT 10
#endif
...
inline void HRangeScrollBar::buttonDraggedCallback (BEvents::Event* event)
{
	...
	const double px = std::max (std::min (w->getPosition().x, x0 + width), x0);
